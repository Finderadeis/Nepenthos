...
public class ActivatableObject : MonoBehaviour, IActivatable, ISaveable
{
    ...
    protected bool baseActiveStatus;
    ...
    {
        baseActiveStatus = ObjectToDeactivate.activeSelf;
    }
    ...
    public virtual void Activate()
    {
        if(hasBeenActivated)
        {
            ObjectToDeactivate.SetActive(!baseActiveStatus);
    ...
    protected virtual void Start() //Will call after it has been loaded to set it active or not
    {
        Activate();
    }
