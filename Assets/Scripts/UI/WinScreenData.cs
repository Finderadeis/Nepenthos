...
public class WinScreenData : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        SetPoints(ref gradePoints, playerDeathAmount, playerDeathsVeryBad, playerDeathsBad, playerDeathsGood, playerDeathsVeryGood);
        SetPoints(ref gradePoints, enemiesAlerted, monsterAlertVeryBad, monsterAlertBad, monsterAlertGood, monsterAlertVeryGood);
        SetPoints(ref gradePoints, enemiesAggressive, monsterAggressiveVeryBad, monsterAggressiveBad, monsterAggressiveGood, monsterAggressiveVeryGood);
        SetPoints(ref gradePoints, (int)completionTime, timeVeryBad, timeBad, timeGood, timeVeryBad);        
    ...
    private void SetPoints(ref int gradePoints, int valueToCheck, int veryBadValue, int badValue, int goodValue, int veryGoodValue)
    {
