...
public class CornerOfTheEye : MonoBehaviour
{
    ...
    private void CheckTargetLayerWithRaycast(Collider other)
    {
        ...
        if (Physics.Raycast(transform.position, other.transform.position, out RaycastHit hit, farthestDistanceInside, allButRaycastLayer, QueryTriggerInteraction.Ignore))
        {
